...
%\hangpara{1cm}{1}\noindent\hspace{.1cm}14. Klausmeier C, \textbf{Osmond M}, Collins K, Litchman E. Submitted to \textit{Philosophical Transactions of the Royal Society B}. Ecological limits to evolutionary rescue.
%
%\hangpara{1cm}{1}\noindent\hspace{.1cm}13. \textbf{Osmond M}, Coop G. In revision for \textit{Genetics}. Genetic signatures of evolutionary rescue by a selective sweep. \textit{bioR$\chi$iv} 10.1101/800201.
%
%\hangpara{1cm}{1}\noindent\hspace{.1cm}12. Henriques GJB, \textbf{Osmond M}. In revision for \textit{Evolution}. During environmental change, cooperation can promote rescue or lead to evolutionary suicide. \textit{bioR$\chi$iv} 10.1101/784553.
